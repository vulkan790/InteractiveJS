import { type Task, type Difficult } from "@/types/domain"
...
export const getTaskById = (id: string): SeedTask | null => {
    return tasks.find(task => task.id === id) || null
}

export const getAllTasks = (): SeedTask[] => {
    return tasks
}

export const getTasksByCategory = (categoryKey: string): SeedTask[] => {
    return tasks.filter(task => task.categoryKey === categoryKey)
}

export const getTasksByDifficulty = (difficulty: Difficult): SeedTask[] => {
